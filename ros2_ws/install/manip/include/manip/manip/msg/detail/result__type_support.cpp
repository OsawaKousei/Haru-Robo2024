...
{
  new (message_memory) manip::msg::Result(_init);
}

void Result_fini_function(void * message_memory)
{
  auto typed_message = static_cast<manip::msg::Result *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Result_message_member_array[2] = {
  {
    ...
    offsetof(manip::msg::Result, feedback),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(manip::msg::Result, num),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::manip::msg::rosidl_typesupport_introspection_cpp::Result_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, manip, msg, Result)() {
  return &::manip::msg::rosidl_typesupport_introspection_cpp::Result_message_type_support_handle;
}
