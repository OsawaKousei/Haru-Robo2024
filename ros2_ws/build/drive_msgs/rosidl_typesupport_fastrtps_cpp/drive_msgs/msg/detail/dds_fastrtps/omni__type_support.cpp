...
#include "drive_msgs/msg/detail/omni__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const drive_msgs::msg::Omni & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  drive_msgs::msg::Omni & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drive_msgs::msg::Omni;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const drive_msgs::msg::Omni *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<drive_msgs::msg::Omni *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Omni__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const drive_msgs::msg::Omni *>(
...
static size_t _Omni__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Omni(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Omni__callbacks = {
  "drive_msgs::msg",
  "Omni",
...
static rosidl_message_type_support_t _Omni__handle = {
...
{
  return &drive_msgs::msg::typesupport_fastrtps_cpp::_Omni__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drive_msgs, msg, Omni)() {
  return &drive_msgs::msg::typesupport_fastrtps_cpp::_Omni__handle;
}
