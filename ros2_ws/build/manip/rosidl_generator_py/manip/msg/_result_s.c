...
bool manip__msg__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("manip.msg._result.Result", full_classname_dest, 24) == 0);
  }
  manip__msg__Result * ros_message = _ros_message;
  {  // feedback
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * manip__msg__result__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Result */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("manip.msg._result");
  ...
  manip__msg__Result * ros_message = (manip__msg__Result *)raw_ros_message;
  {  // feedback
    PyObject * field = NULL;
