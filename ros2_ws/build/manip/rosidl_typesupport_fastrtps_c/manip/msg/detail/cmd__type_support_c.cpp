...
#include "manip/msg/detail/cmd__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // base1, base2, work1, work2
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // base1, base2, work1, work2

// forward declare type support functions


using _Cmd__ros_msg_type = manip__msg__Cmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: work1
  {
    size_t size = ros_message->work1.size;
    auto array_ptr = ros_message->work1.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  // Field name: work2
  {
    size_t size = ros_message->work2.size;
    auto array_ptr = ros_message->work2.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: work1
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->work1.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->work1);
    }
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->work1, size)) {
      fprintf(stderr, "failed to create array for field 'work1'");
      return false;
    }
    auto array_ptr = ros_message->work1.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  // Field name: work2
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->work2.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->work2);
    }
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->work2, size)) {
      fprintf(stderr, "failed to create array for field 'work2'");
      return false;
    }
    auto array_ptr = ros_message->work2.data;
    cdr.deserializeArray(array_ptr, size);
...
size_t get_serialized_size_manip__msg__Cmd(
  const void * untyped_ros_message,
...
static uint32_t _Cmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_manip__msg__Cmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_manip
size_t max_serialized_size_manip__msg__Cmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = manip__msg__Cmd;
    is_plain =
      (
...
static size_t _Cmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_manip__msg__Cmd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, manip, msg, Cmd)() {
