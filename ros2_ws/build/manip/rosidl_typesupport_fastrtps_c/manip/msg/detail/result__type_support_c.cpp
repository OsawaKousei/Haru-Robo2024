...
#include "manip/msg/detail/result__rosidl_typesupport_fastrtps_c.h"
...
using _Result__ros_msg_type = manip__msg__Result;
...
size_t get_serialized_size_manip__msg__Result(
  const void * untyped_ros_message,
...
static uint32_t _Result__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_manip__msg__Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_manip
size_t max_serialized_size_manip__msg__Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = manip__msg__Result;
    is_plain =
      (
...
static size_t _Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_manip__msg__Result(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, manip, msg, Result)() {
